...
const CACHE_VERSION = 'xcleaners-v10';
...
const SHELL_ASSETS = [
  '/cleaning/app',
  '/cleaning/static/css/design-system.css?v=8',
  '/cleaning/static/css/app.css?v=8',
  '/cleaning/static/css/schedule.css?v=8',
  '/cleaning/static/js/shared/demo-data.js?v=8',
  '/cleaning/static/js/shared/cleaning-api.js?v=8',
  '/cleaning/static/js/shared/sse-client.js?v=8',
  '/cleaning/static/js/shared/offline-store.js?v=8',
  '/cleaning/static/js/shared/i18n.js?v=8',
  '/cleaning/static/js/auth-ui.js?v=8',
  '/cleaning/static/js/router.js?v=8',
  '/cleaning/static/js/app.js?v=8',
